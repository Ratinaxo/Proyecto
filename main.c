  ...
  while (true){
    ...
    switch (opcionInstrucciones)
    {
      ...
      case 1:
        ...
        printf("|Los terrenos son: bosques (maderas), colinas (ladrillos), praderas (ovejas), cultivos (trigos) y canteras (rocas)                          |\n");
